...
export default function App() {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}>
        <h1 style={s.title}>Platform Home</h1>
        <p style={s.sub}>
          Sample splash page served at <span style={{ fontFamily: 'monospace', color: '#e9ecef' }}>/</span>.
      ...
      <div style={s.body}>
        ...
        <div style={s.section}>
          ...
          {loading ? (
            ...
            <p style={s.empty}>
              No custom apps deployed yet. Add a folder under <code style={s.code}>application/</code> and push to main.
              Each app is accessible at <code style={s.code}>/<em>app-name</em></code>.
            </p>
          ) : (
            <div style={s.grid}>
              {customApps.map(app => (
